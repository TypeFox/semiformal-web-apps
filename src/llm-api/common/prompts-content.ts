...
export const COMMON_BACKEND_ASSISTANT_MESSAGE = "I will first generate the backend service for you."
export const COMMON_FRONTEND_ASSISTANT_MESSAGE = "Now I will generate the frontend service."
